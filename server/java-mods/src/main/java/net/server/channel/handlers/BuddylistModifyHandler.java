...
public class BuddylistModifyHandler extends AbstractPacketHandler {
    ...
    public void handlePacket(InPacket p, Client c) {
        ...
        if (mode == 1) { // add
            ...
            // Prevent adding bots to buddy list — they have no DB-backed account
            if (BotManager.getInstance().isBotName(addName)) {
                c.sendPacket(PacketCreator.serverNotice(1, "\"" + addName + "\" cannot be added to your Buddylist."));
                return;
            }
