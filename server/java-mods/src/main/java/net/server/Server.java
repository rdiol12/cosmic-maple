...
public class Server {
    ...
    private server.life.BotHttpServer botHttpServer;
    ...
    public void init() {
        ...
        // Start bot HTTP API server and auto-spawn configured bots
        botHttpServer = new server.life.BotHttpServer();
        botHttpServer.start();
        server.life.BotManager.getInstance().onServerReady();
    }
    ...
    */
    ...
    private synchronized void shutdownInternal(boolean restart) {
        ...
        // Shut down bot system
        server.life.BotManager.getInstance().shutdown();
        if (botHttpServer != null) {
            botHttpServer.stop();
        }
